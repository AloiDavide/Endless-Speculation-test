---
{"dg-publish":true,"permalink":"/mysteries/episode-3-mysteries/crime-scenes-of-the-6-linked-closed-rooms/","contentClasses":"center-headings red-truth red-links blue-truth","tags":["banquet"]}
---


## Axioms
While she doesn't repeat it in red every time, all six rooms will be assumed to fit Beatrice's definition of a [[Speculation/Beatrice's Definitions\|closed room]].

#### Banquet
- __There are five__ (master keys)__, one for each servant__
...
| Discovery | Character | Room                   |
| --------- | --------- | ---------------------- |
| 1.        | Shannon   | Parlor                 |
| 2.        | Kumasawa  | 2nd floor guest room   |
| 3.        | Gohda     | 3rd floor waiting room |
| 4.        | Kinzo     | Boiler room            |
| 5         | Genji     | 2nd floor VIP room     |
| 6         | Kanon     | Chapel                 |
...
We solve this by semantically declaring Kanon and Shannon dead despite Sayo being alive like we did in Turn. She was shot during a disagreement and is wounded, and according to the red they only __appeared__ to be fatally wounded.

Additionally, a 7th unconscious person being present out of sight next to Sayo solves it (not hiding, just unconscious).

Other points of flexibility are the definition of the word "corpse" and "The linked closed rooms" possibly being be the name of the mystery and not a property of the rooms.
